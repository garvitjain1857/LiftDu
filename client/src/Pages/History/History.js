            ...
            <div style={{width : "80%", height : "100vh", display: "flex", flexDirection : "column", alignItems : "center"}}>
                ...
                <div style={{width: "80%", height : "fit-content", display: "flex"}}>
                    <div className="history-card-container">
                        <HistoryCard name="Garvit Jain" dist="2.3" rat="3.5" pri="6"/>
                        <HistoryCard name="Abhisekh Bohra" dist="10.4" rat="4.3" pri="10"/>
                        <HistoryCard name="Shyam Suthar" dist="2.6" rat="3.2" pri="7"/>
                        <HistoryCard name="Anuradha Bhagat" dist="5.0" rat="4.8" pri="15"/>
                        <HistoryCard name="Priyanka" dist="3.8" rat="4.5" pri="8"/>
                        <HistoryCard name="Deepak Kumar" dist="1.3" rat="4.2" pri="4"/>
                        <HistoryCard name="Bharat" dist="19.3" rat="3.1" pri="40"/>
