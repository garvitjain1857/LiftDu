...
import { address } from "../../smartContractInfo.js";
...
class Order extends Component {
  ...
  const etherCost = ethers.utils.parseUnits((COST * 0.0031).toString(), "ether");
  console.log("etherCost:", etherCost.toString());

  const tx = await this.props.signer.sendTransaction({
    to: address,
    value: etherCost
  });

  const bigEtherCost = etherCost.div(ethers.constants.WeiPerEther).toNumber();
  console.log("bigEtherCost:", bigEtherCost);
              ...
              this.state.loading
                ...
                <div style={{ display: "flex" }}>
                  <div style={{ display: "flex", flexDirection: "column", width: "fit-content" }}>
                    ...
                    <DriverCard name="Shyam Suthar" />
                    <DriverCard name="Deepak Kumar" />
                    <DriverCard name="Anuradha Bhagat" />
                    <DriverCard name="Priyanka" />
                    <DriverCard name="Abhisekh Bohra" />
                  </div>
